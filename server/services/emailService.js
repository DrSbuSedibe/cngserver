...
const RESEND_API_KEY = process.env.RESEND_API_KEY || process.env.RESEND_APIKEY;
const RESEND_FROM = process.env.RESEND_FROM || 'onboarding@resend.dev';
const RESEND_TEST_RECIPIENT = process.env.RESEND_TEST_RECIPIENT || RECEIVER_EMAILS || '';
  ...
  return {
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e0e0e0; border-radius: 5px;">
        <div style="background-color: #16B44B; padding: 15px; border-radius: 5px 5px 0 0; margin: -20px -20px 20px -20px;">
        ...
        <table style="width: 100%; border-collapse: collapse; margin: 15px 0;">
          <tr>
            <td style="padding: 8px; background-color: #f0faf3; font-weight: bold; width: 150px; color: #16B44B;">Tracking Code:</td>
            <td style="padding: 8px; background-color: #f0faf3;">${trackingCode}</td>
          </tr>
          <tr>
        ...
        <div style="background-color: #f0faf3; padding: 10px; border-left: 4px solid #F68B11; margin: 15px 0; font-size: 12px; color: #666;">
